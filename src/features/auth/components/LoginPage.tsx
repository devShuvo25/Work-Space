    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-brand-accent shrink-0 shadow-lg shadow-slate-900/10">
            <Building2 size={20} />
          </div>
          <div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 mt-4 bg-brand-accent cursor-pointer text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-brand-accent hover:text-slate-900 transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-xl shadow-slate-900/10"
          >
