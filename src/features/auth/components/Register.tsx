    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-brand-accent shrink-0">
            <Building2 size={20} />
          </div>
          <div>
            <h2 className="text-xl font-black text-slate-900 leading-none uppercase tracking-tighter">Register</h2>
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">StudioPorto Network</p>
          </div>
        </div>
        ...
        <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-1">
            ...
            />
            {errors.name && <p className="text-[9px] text-red-500 font-bold ml-2">{errors.name.message}</p>}
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 mt-2 bg-brand-accent text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-brand-accent hover:text-slate-900 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-6 text-center">
          <Link href="/login" className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors">
            Have account? <span className="text-slate-900 border-b border-yellow-400">Login</span>
          </Link>
        </div>
      </motion.div>
    </div>
